              ...
              <View style={{flexDirection:"row",overflow:"hidden",justifyContent:"space-between",padding:15,backgroundColor:item.backgroundColor,marginHorizontal:26,marginBottom:10,borderRadius:10}}>
                <View style={{justifyContent:"space-between"}}>
                  ...
                  <TouchableOpacity style={{backgroundColor:"#fff",width:70,padding:5,borderRadius:6,marginTop:50}} onPress={item.onPressHandler}>
                    <Text style={{textAlign:"center",fontWeight:"bold",color:'black'}}>Select</Text>
                  </TouchableOpacity>
                </View>
                <View>
                  <Image
          ...
          <View style={styles.container}>
              ...
              <CustomCard elevated={true} style={{backgroundColor:"#fff",marginHorizontal:24,marginTop:-40,padding:30,borderRadius:10,flexDirection:"row",justifyContent:"space-between"}}>
                  <View style={{alignItems:"center",}}>
                    <Text style={{fontWeight:"bold", marginBottom:10,color:'black'}}>Balance</Text>
                    <Text style={{fontWeight:"bold",fontSize:18,color:'black'}}>$ 18</Text>
                  </View>
                  <View style={{alignItems:"center"}}>
                    <Text style={{fontWeight:"bold", marginBottom:10,color:'black'}}>Rewards</Text>
                    <Text style={{fontWeight:"bold",fontSize:18,color:'black'}}>$ 10.25</Text>
                  </View>
                  <View style={{alignItems:"center"}}>
                    <Text style={{fontWeight:"bold", marginBottom:10,color:'black'}}>Total Trips</Text>
                    <Text style={{fontWeight:"bold",fontSize:18,color:'black'}}>189</Text>
                  </View>
                </CustomCard>
                <Text style={{marginHorizontal:26,marginVertical:20,fontWeight:"bold",fontSize:20, color:'black'}}>Choose your Transport</Text>
                <View>
                    <FlatList
                    data={DATA}
